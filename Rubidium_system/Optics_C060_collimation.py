...
#                                       mount_type=optomech.rotation_stage_rsp05)
    ...
    baseplate.place_element_along_beam("Mirror", optomech.mirror_2inch, beam,
                                       beam_index=0b1, distance=135, angle=layout.turn['left-down'],
...
# distance from the last AL50100 lens to the f60 lens should be 483.399
    ...
    baseplate.place_element_along_beam("AL7560B", optomech.Mounted_asphere_60, beam,
                                       beam_index=0b1, distance=100-2, angle=layout.cardinal['up'])

    # next distance is 357.978 to go to the 4 inch, f=150mm lens, minus 75.389

    baseplate.place_element_along_beam("Mirror", optomech.mirror_2inch, beam,
                                       beam_index=0b1, distance=100+21.905+3, angle=layout.turn['down-right'],
                                       mount_type=optomech.mirror_mount_KM2CE)

    baseplate.place_element_along_beam("AL75150", optomech.Mounted_asphere_150, beam,
                                       beam_index=0b1, distance=99, angle=layout.cardinal['right'])

    baseplate.place_element_along_beam("Mirror", optomech.mirror_2inch, beam,
                                       beam_index=0b1, distance=43, angle=layout.turn['right-up'],
                                       mount_type=optomech.mirror_mount_KM2CE)
    ...
    baseplate.place_element_along_beam("AL7560B", optomech.Mounted_asphere_60, beam,
                                       beam_index=0b1, distance=185.173, angle=layout.cardinal['down'])


    # next distance should be 166.961

    baseplate.place_element_along_beam("Mirror", optomech.mirror_2inch, beam,
                                       beam_index=0b1, distance=100+24.65+30, angle=layout.turn['up-left'],
                                       mount_type=optomech.mirror_mount_KM2CE)

    baseplate.place_element_along_beam("AL75150B", optomech.Mounted_asphere_150, beam,
                                       beam_index=0b1, distance=75-8+33.61-31, angle=layout.cardinal['left'])
...
# and it will be another f150 asphere
    ...
    baseplate.place_element_along_beam("Mirror", optomech.mirror_2inch, beam,
                                       beam_index=0b1, distance=153, angle=layout.turn['left-up'],
                                       mount_type=optomech.mirror_mount_KM2CE)
...
# next distance should be 413.036mm to the 2nd f200 lens
    ...
    baseplate.place_element_along_beam("Mirror", optomech.mirror_2inch, beam,
                                       beam_index=0b1, distance=180, angle=layout.turn['up-right'],
                                       mount_type=optomech.mirror_mount_KM2CE)

    baseplate.place_element_along_beam("Mirror", optomech.mirror_2inch, beam,
                                       beam_index=0b1, distance=75, angle=layout.turn['right-up'],
                                       mount_type=optomech.mirror_mount_KM2CE)
